...
/*
  ...
  options:
      ...
      - ignoreFields: (default = false) if some of the objects have not the same fields than the subject it continues making the match instead of throw an error.
*/
  ...
  module.exports = function(subject, objects, options) {
    ...
    for (attr in subject) {
      for (_i = 0, _len = objects_mapped.length; _i < _len; _i++) {
        o = objects_mapped[_i];
        if (!(attr in o)) {
          if ((options != null ? options.ignoreFields : void 0) === true) {
            o[attr] = 0;
          } else {
